...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        if (Jun.Toolkit.SessionHelper.Get("userrank") == "1" || Jun.Toolkit.SessionHelper.Get("userrank") == "2"
            || Jun.Toolkit.SessionHelper.Get("userrank") == "3")
        {
            acl.FolderView = true;
        ...
        if (Jun.Toolkit.SessionHelper.Get("user") != "" && Jun.Toolkit.SessionHelper.Get("userrank") == "1")
        {
            type.MaxSize = Jun.Toolkit.Validator.StrToInt(Jun.WebHelper.Sysconfig.GetConfig("cfg_filestypesize"), 102400) * 1024;
        }
        else
        {
            type.MaxSize = Jun.Toolkit.Validator.StrToInt(Jun.WebHelper.Sysconfig.GetConfig("cfg_filestypefrontsize"), 1024) * 1024;
        }
        type.AllowedExtensions = Jun.WebHelper.Sysconfig.GetConfig("cfg_filestype").Split('|');
        ...
        if (Jun.Toolkit.SessionHelper.Get("user") != "" && Jun.Toolkit.SessionHelper.Get("userrank") == "1")
        {
            type.MaxSize = Jun.Toolkit.Validator.StrToInt(Jun.WebHelper.Sysconfig.GetConfig("cfg_imagestypesize"), 2048) * 1024;
        }
        else
        {
            type.MaxSize = Jun.Toolkit.Validator.StrToInt(Jun.WebHelper.Sysconfig.GetConfig("cfg_imagestypefrontsize"), 1024) * 1024;
        }
        type.AllowedExtensions = Jun.WebHelper.Sysconfig.GetConfig("cfg_imagestype").Split('|');
        type.DeniedExtensions = new string[] { };
        ...
        if (Jun.Toolkit.SessionHelper.Get("user") != "" && Jun.Toolkit.SessionHelper.Get("userrank") == "1")
        {
            type.MaxSize = Jun.Toolkit.Validator.StrToInt(Jun.WebHelper.Sysconfig.GetConfig("cfg_flashtypesize"), 4096) * 1024;
        }
        else
        {
            type.MaxSize = Jun.Toolkit.Validator.StrToInt(Jun.WebHelper.Sysconfig.GetConfig("cfg_flashtypefrontsize"), 1024) * 1024;
        }
        type.AllowedExtensions = Jun.WebHelper.Sysconfig.GetConfig("cfg_flashtype").Split('|');
        type.DeniedExtensions = new string[] { };
	}
